...
static void lcd_implementation_status_screen()
{
	...
	{
		if(!LaserState)
			u8g.drawBitmapP(0,0,STATUS_LASER_SCREENBYTEWIDTH,STATUS_LASER_SCREENHEIGHT,status_screen_laseroff_bmp);
		else
			if((blink % 2)) u8g.drawBitmapP(0,0,STATUS_LASER_SCREENBYTEWIDTH,STATUS_LASER_SCREENHEIGHT,status_screen_laseron1_bmp);
			else u8g.drawBitmapP(0,0,STATUS_LASER_SCREENBYTEWIDTH,STATUS_LASER_SCREENHEIGHT,status_screen_laseron2_bmp);

		u8g.setFont(u8g_font_6x10_marlin);
		u8g.drawStr(25,10,"LASER CUTTER");
		u8g.setFont(FONT_STATUSMENU);
		u8g.setPrintPos(30,20);
		if(LaserEnabled)
			u8g.print(MSG_MODE_LASEREN);
		else
			u8g.print(MSG_MODE_LASERDIS);
		u8g.setPrintPos(60,20);
		u8g.print(MSG_LASERPWR);
		u8g.print(itostr3((100*LaserPWR)/255));
		u8g.print('%');
